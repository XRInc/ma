	...
	<div class="page">
		<div class="payment-l">
			<div class="border-box">
				<form id="mcForm" method="post" target="_top" action="<?php echo href_link(FILENAME_CHECKOUT_PROCESS, '', 'SSL'); ?>" onSubmit="return checkForm();">
							...
							<ul class="payform">
								<li class="field-card" id="borderCard">
									<div id="card" class="input-box">
										...
										<input type="tel" class="input-text" name="gppayment_card_number" id="txtCardNumber" maxLength="16" onkeyup="checkCardNumber();" oninput="checkCardNumber();" />
									</div>
								...
								<li class="field-wrapper">
									<div class="field f-left" id="borderDate">
										...
										<div class="input-box">
											<select name="gppayment_card_month" id="selCardMonth">
												<option value=""><?php echo __('Month'); ?></option>
												<?php for ($i = 1; $i <= 12; $i++) { ?>
													<option value="<?php echo str_pad($i, 2, '0', STR_PAD_LEFT); ?>"><?php echo str_pad($i, 2, '0', STR_PAD_LEFT); ?></option>
												<?php } ?>
											</select>
											<select class="f-right" name="gppayment_card_year" id="selCardYear">
									...
									<div class="field f-right" id="borderCVV">
										...
										<div class="input-box">
											<input type="tel" class="input-text" name="gppayment_card_cvv" id="txtCardCVV" maxLength="4" onkeyup="this.value=this.value.replace(/\D/g,'')" oninput="this.value=this.value.replace(/\D/g,'')" />
										</div>
					...
					<script type="text/javascript">
						...
						function checkForm(){
							...
							if (error) {
								...
								document.getElementById("client_ip").value = returnCitySN["cip"];
