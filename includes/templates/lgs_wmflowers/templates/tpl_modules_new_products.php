...
<div class="new-products">
	<!-- <div class="page-title add_iptitle">
        ...
        <p class="p1">Amazing products added recently in our catalog</p>
	</div> -->
	...
	<div id="product_new" >
		...
		<div class="col-xs-6 col-sm-4 col-md-3 products-grid add_ip img_box">
			<a href="<?php echo href_link(FILENAME_PRODUCT, 'pID=' . $_product['product_id']); ?>" title="<?php echo $_product['nameAlt']; ?>" class="product-image">
				<img class="img-responsive" width="<?php echo NEW_PRODUCTS_IMAGE_WIDTH; ?>" height="<?php echo NEW_PRODUCTS_IMAGE_HEIGHT; ?>" alt="<?php echo $_product['nameAlt']; ?>" src="<?php echo get_small_image($_product['image'], NEW_PRODUCTS_IMAGE_WIDTH, NEW_PRODUCTS_IMAGE_HEIGHT); ?>" />
                <div class="add_proqv">
