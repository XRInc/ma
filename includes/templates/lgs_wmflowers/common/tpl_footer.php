<div class="footer-container" style="width: 100%;text-align: center">
	<div class="footer">
		<div class="add_container">
			<div class="row">
                <div class="search col-md-3 col-sm-6" id="search_input">
                ...
                <div class="col-md-3 col-sm-6 add_fagr">
					<div class="fagr_box">
                        <div class="fagr_item">
                            <div class="fagr_icon fagr_icon1">
                                <i></i>
                            </div>
                            <div class="fagr_msg">
                                <p class="p1">FREE SHIPPING & RETURN</p>
                                <p class="p2">Free shipping on all orders over $99.</p>
                            </div>
                        </div>
                        <div class="fagr_item">
                            <div class="fagr_icon fagr_icon2">
                                <i></i>
                            </div>
                            <div class="fagr_msg">
                                <p class="p1">MONEY BACK GUARANTEE</p>
                                <p class="p2">100% money back guarantee</p>
                            </div>
                        </div>
                        <div class="fagr_item">
                            <div class="fagr_icon fagr_icon3">
                                <i></i>
                            </div>
                            <div class="fagr_msg">
                                <p class="p1">ONLINE SUPPORT 24/7</p>
                                <p class="p2">Lorem ipsum dolor sit amet.</p>
                            </div>
                        </div>
                    </div>
				</div>
				<div class="col-md-2 col-sm-4 mob_footer footer_company_info">
				...
				<div class="col-md-2 col-sm-4 mob_footer customer_service">
				...
				<div class="col-md-2 col-sm-4 mob_footer my_account">
				...
				<div class="col-md-3 col-sm-6 mob_footer" style="display: none;">
	...
	<div class="footer-bottom">
		<div class="container">
			<div class="row">
				...
				<div class="foot_pay hidden-sm hidden-xs">
					<img src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>footer-right.png" alt="">
				</div>
				<div class="col-md-12 col-sm-12 col-xs-12">
					<img class="img-responsive hidden-md hidden-lg" src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>footer-right.png" />
				</div>
			</div>
		</div>
	</div>
