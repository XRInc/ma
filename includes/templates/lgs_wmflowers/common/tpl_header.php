...
<div class="pc-header hidden-xs hidden-sm">
	<div class="header">
        <div class="header-container" style="background:#2eb319 ">
            <div class="container">
                <p class="welcome-msg">
                    <a href="#">
		...
		<div class="nav-container add_nav-container">
			<div id="nav">
                
                <div class="logo-img">
                    
                    <a href="<?php echo href_link(FILENAME_INDEX); ?>">
						<img src="<?php echo $template->get_template_dir(HEADER_LOGO_SRC, DIR_WS_TEMPLATE, $current_page, 'images') . HEADER_LOGO_SRC; ?>" alt="">
					</a>
				</div>
                <div class="logo-img">
                ...
                <ul class="links">
                    <li>
                        <div class="add_search" id="pc_search_btn">
                            ...
                            <form method="get" action="<?php echo href_link(FILENAME_SEARCH); ?>" id="pc_search_mini_form" class="search_mini_form add_hid">
                    ...
                    <li><a title="<?php echo __('Order Check'); ?>" href="<?php echo href_link(FILENAME_SEARCH_ORDER, '', 'SSL'); ?>" rel="external nofollow"></a></li>
...
<div class="mobile-header hidden-md hidden-lg">
	...
	<div class="header" style="display:flex; justify-content: space-between;">
		...
		<div class="add_m_nav">
            <a class="link-account" title="<?php echo __('My Account'); ?>" href="<?php echo href_link(FILENAME_ACCOUNT, '', 'SSL'); ?>"><i class="iconfont">&#xe699;</i></a>
            <div class="add_search">
                <a style="cursor: pointer;" onclick="addC(this);"><i class="iconfont add_iconfont add_iconfont_hid f-25" >&#xe630;</i></a>
                <form method="get" action="<?php echo href_link(FILENAME_SEARCH); ?>" id="m_search_mini_form" class="search_mini_form add_hid">
                    <div class="form-search add_form-search">
                        <?php if (USE_URL_REWRITE == 0){ ?>
                            <input type="hidden" value="search" name="main_page">
                        <?php } ?>
            ...
            <a class="link-cart a-right" href="<?php echo href_link(FILENAME_SHOPPING_CART, '', 'SSL'); ?>" rel="external nofollow"><i class="iconfont f-25">&#xe600;</i></a>
        </div>
	</div>
