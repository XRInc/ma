...
<div class="pc-header hidden-xs hidden-sm">
	<div class="header">
		...
		<!-- <div class="logo-img"> -->
			<a href="<?php echo href_link(FILENAME_INDEX); ?>"style="display: block;position: absolute;left: 50%;top: 50%;transform: translate(-50%, -50%);">
	...
	<div class="nav-container">
		<div id="nav">
			<div id="nav" style="display: flex;">
				<div class="nav-center" style="display: flex;justify-content: center;align-items: center;align-content: center;width: 100%;">
...
<div class="mobile-header hidden-md hidden-lg">
	<div class="header">
		...
		<div class="col-xs-6 col-sm-6"><a class="logo" href="<?php echo href_link(FILENAME_INDEX); ?>"><img src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>logo.png" alt="<?php echo HEADER_LOGO_ALT; ?>" title="<?php echo HEADER_LOGO_ALT; ?>"/></a></div>
		<div class="col-xs-3 col-sm-3"><a class="link-cart a-right" href="<?php echo href_link(FILENAME_SHOPPING_CART, '', 'SSL'); ?>" rel="external nofollow"><i class="iconfont f-25">&#xe600;</i></a></div>
	</div>
