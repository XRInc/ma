...
<div class="ordered-products">
    ...
    <div class="add_iptitle">
        <div class="p12">
            <p class="p1"><?php echo __('Recent Shopping'); ?></p>
    ...
    <div id="product_order">
		...
		<div class="col-xs-6 col-sm-4 col-md-3 products-grid add_ip img_box">
    		<a href="<?php echo href_link(FILENAME_PRODUCT, 'pID=' . $_product['product_id']); ?>" title="<?php echo $_product['nameAlt']; ?>" class="product-image">
                <img class="img-responsive" width="<?php echo ORDERED_PRODUCTS_IMAGE_WIDTH; ?>" height="<?php echo ORDERED_PRODUCTS_IMAGE_HEIGHT; ?>" alt="<?php echo $_product['nameAlt']; ?>" src="<?php echo get_small_image($_product['image'], ORDERED_PRODUCTS_IMAGE_WIDTH, ORDERED_PRODUCTS_IMAGE_HEIGHT); ?>" />
                <div class="add_proqv">
