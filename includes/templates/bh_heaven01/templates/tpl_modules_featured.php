...
<div class="featured">
    ...
    <div class="add_iptitle">
        <div class="p12">
            <p class="p1"><?php echo __('Featured'); ?></p>
	...
	<?php foreach ($featuredList as $_product) { ?>
    	<div class="col-xs-6 col-sm-4 col-md-3 products-grid add_ip img_box">
    		<a href="<?php echo href_link(FILENAME_PRODUCT, 'pID=' . $_product['product_id']); ?>" title="<?php echo $_product['nameAlt']; ?>" class="product-image">
                <img class="img-responsive" width="<?php echo FEATURED_IMAGE_WIDTH; ?>" height="<?php echo FEATURED_IMAGE_HEIGHT; ?>" alt="<?php echo $_product['nameAlt']; ?>" src="<?php echo get_small_image($_product['image'], FEATURED_IMAGE_WIDTH, FEATURED_IMAGE_HEIGHT); ?>" />
                <div class="add_proqv">
