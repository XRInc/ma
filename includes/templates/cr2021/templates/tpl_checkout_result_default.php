								...
								<?php if(is_array($remarks)) { ?>
									<td>
										<?php foreach($remarks as $val) { ?>
											Tracking Website <br><strong><a href="<?php echo $val['wayUrl']; ?>" target="_blank"><?php echo $val['wayUrl'];?></a></strong><br><br>Tracking Number <br><strong><?php echo $val['number']; ?></strong>
										<?php } ?>
									</td>
								<?php } else { ?>
