	...
	<table class="table table-bordered data-table cart-table" id="shopping-cart-table">
		...
		<tfoot>
			...
			<tr class="grand_total">
				...
				<td colspan="3"><a class="btn-continue f-left" title="<?php echo __('Continue Shopping'); ?>" href="<?php echo back_url(); ?>"><small>« </small><?php echo __('Continue Shopping'); ?></a><strong class="f-right"><?php echo __('Grand Total'); ?><span class="price visible-xs a-right"><?php echo $currencies->display_price($grand_total); ?></span></strong></td>
...
<?php if (SHOPPING_CART_MODE == 0) { ?>
	<?php if ($_SESSION['asb_payment_status'] == '1') { ?>
		<?php require($template->get_template_dir('tpl_modules_checkout_info_asb.php', DIR_WS_TEMPLATE, $current_page, 'templates') . 'tpl_modules_checkout_info_asb.php'); ?>
	<?php } else { ?>
