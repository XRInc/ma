		...
		<?php if ($productListCount = count($productList)) { ?>
			...
			<div class="row">
				<?php foreach ($productList as $_product) { ?>
					<div class="col-xs-6 col-sm-3 col-md-4 products-grid" >
						<div class="products-bg">
							...
							<h2 class="product-name hidden-xs hidden-sm"><a href="<?php echo href_link(FILENAME_PRODUCT, 'pID=' . $_product['product_id']); ?>" title="<?php echo $_product['nameAlt']; ?>"><?php echo $_product['name']; ?></a></h2>
							<h2 class="product-name hidden-lg hidden-md"><a href="<?php echo href_link(FILENAME_PRODUCT, 'pID=' . $_product['product_id']); ?>" title="<?php echo $_product['nameAlt']; ?>"><?php echo $_product['name']; ?></a></h2>
							<div class="product-shop">
								<div class="price-box">
									<?php if ($_product['specials_price'] > 0) { ?>
										<p class="old-price a-right">
