<?php include(DIR_FS_CATALOG_MODULES . get_module_directory('also_purchased.php')); ?>
<?php if ($alsoPurchasedListCount = count($alsoPurchasedList)) {?>
<div class="box-also">
	<div class="page-title">
		<h2 class="subtitle"><?php echo __('You may also like'); ?></h2>
	</div>
	<div class="">
		<?php foreach ($alsoPurchasedList as $_product) { ?>
			<div class="col-xs-6 col-sm-4 col-md-3 products-grid">
				<a href="<?php echo href_link(FILENAME_PRODUCT, 'pID=' . $_product['product_id']); ?>" title="<?php echo $_product['nameAlt']; ?>" class="product-image"><img class="img-responsive" width="<?php echo ALSO_PURCHASED_IMAGE_WIDTH; ?>" height="<?php echo ALSO_PURCHASED_IMAGE_HEIGHT; ?>" alt="<?php echo $_product['nameAlt']; ?>" src="<?php echo get_small_image($_product['image'], ALSO_PURCHASED_IMAGE_WIDTH, ALSO_PURCHASED_IMAGE_HEIGHT); ?>" /></a>
