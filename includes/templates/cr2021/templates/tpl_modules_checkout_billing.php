...
<div class="step" id="checkout-step-billing">
	...
	<div id="billing-new-address-form">
		...
		<?php if (!isset($_SESSION['customer_id'])) { ?>
			<div class="form-group">
				<label class="required" for="billing-email_address"><em>*</em><?php echo __('Email Address'); ?></label><span style="font-size:12px;display:block;">Please make sure it's correct, otherwise you won't receive your order info.</span>
		...
		<?php } ?>
		<div class="form-group">
			<label class="required" for="billing-street_address"><em>*</em><?php echo __('Street Address'); ?></label><span style="font-size:12px;display:block;">Please do not forget the apt/door# if you have,  otherwise your order won't be delivered.</span>
