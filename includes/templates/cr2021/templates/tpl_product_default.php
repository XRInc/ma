		...
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 product-shop-box">
			<form id="form-validate" method="post" action="<?php echo href_link(FILENAME_PRODUCT, 'pID=' . $productInfo['product_id'] . '&action=add_product'); ?>">
				...
				<div class="review-box">
					...
					<a rel="nofollow" href="javascript:;" id="click-customer-review" style="text-decoration: underline !important;"><?php echo $productInfo['review']['total']; ?>&nbsp;Reviews</a>&nbsp;
					
					<?php } ?>
					<script type="text/javascript">
						$(function() {
							$("#click-customer-review").click(function() {
								$("html, body").animate({
								  scrollTop: $(".pr-contents-wrapper").offset().top }, {duration: 500,easing: "swing"});
								return false;
							  });
						});
					</script>
	...
	<div class="product-descreview">
		<ul class="cos-listView">
			<?php if (not_null($productInfo['description'])) { ?>
					<a class="cosTab" id="proDescription" href="#proDescription"><!-- <span class="cos-arrow"></span> --><?php echo __('Description'); ?></a>
					<div class="std proDescription_desc"><?php echo $productInfo['description']; ?></div>
			<?php } ?>
