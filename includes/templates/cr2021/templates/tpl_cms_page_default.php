<div class="account-top">
	<div class="page-title">
		<h1><?php echo $cmsPageInfo['name']; ?><a class="f-right account-more visible-xs"><i class="iconfont">&#xe609;</i></a></h1>
	</div>
	<div class="account-menu">
		<ul>
			<?php foreach ($cmsPageSidebarList as $val) { ?>
				<?php if(isset($_GET['cpID'])&&$_GET['cpID']!=$val['cms_page_id']) { ?>
					<li><a href="<?php echo href_link(FILENAME_CMS_PAGE, 'cpID=' . $val['cms_page_id']); ?>" rel="external nofollow"><?php echo $val['name']; ?></a></li>
				<?php } ?>
			<?php } ?>
		</ul>
	</div>
