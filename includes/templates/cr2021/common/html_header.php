...
<link rel="icon" href="<?php echo DIR_WS_TEMPLATE; ?>favicon<?php echo (IS_ZP == 1) ? '_zp' : ''; ?>.ico?v0306" type="image/x-icon" />
<link rel="shortcut icon" href="<?php echo DIR_WS_TEMPLATE; ?>favicon<?php echo (IS_ZP == 1) ? '_zp' : ''; ?>.ico?v0306" type="image/x-icon" />
<base href="<?php echo (($request_type=='SSL')?HTTPS_SERVER:HTTP_SERVER) . DIR_WS_CATALOG; ?>" />
<link href="<?php echo $metaInfo['canonical']; ?>" rel="canonical" />
<link rel="stylesheet" type="text/css" href="//at.alicdn.com/t/font_375202_e3qlkzj62zwwxw29.css" />
