...
<div class="featured">
	...
	<div class="owl-banner-box" id="index_owl">
	<?php foreach ($featuredList as $_product) { ?>
    	<div class="products-grid">
    		<a href="<?php echo href_link(FILENAME_PRODUCT, 'pID=' . $_product['product_id']); ?>" title="<?php echo $_product['nameAlt']; ?>" class="product-image"><img class="img-responsive" width="<?php echo FEATURED_IMAGE_WIDTH; ?>" height="<?php echo FEATURED_IMAGE_HEIGHT; ?>" alt="<?php echo $_product['nameAlt']; ?>" src="<?php echo get_small_image($_product['image'], FEATURED_IMAGE_WIDTH, FEATURED_IMAGE_HEIGHT); ?>" /></a>
