...
<div class="ordered-products">
    ...
    <div class="row">
		...
		<div class="col-xs-12 col-sm-4 col-md-3 products-grid">
    		<a href="<?php echo href_link(FILENAME_PRODUCT, 'pID=' . $_product['product_id']); ?>" title="<?php echo $_product['nameAlt']; ?>" class="product-image"><img class="img-responsive" width="<?php echo ORDERED_PRODUCTS_IMAGE_WIDTH; ?>" height="<?php echo ORDERED_PRODUCTS_IMAGE_HEIGHT; ?>" alt="<?php echo $_product['nameAlt']; ?>" src="<?php echo get_small_image($_product['image'], ORDERED_PRODUCTS_IMAGE_WIDTH, ORDERED_PRODUCTS_IMAGE_HEIGHT); ?>" /></a>
