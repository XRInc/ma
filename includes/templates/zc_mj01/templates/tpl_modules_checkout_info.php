...
<style>
	...
	.cart_limit div{height: 200px; border-radius: 15px;box-shadow: 0 0 10px #b5b3b3;padding: 20px;line-height: 23px;width: 370px;transform: translateX(-50%);margin-left: unset;}
