...
<meta name="renderer" content="webkit">
    ...
    <?php } else { ?>
        <link rel="icon" href="<?php echo DIR_WS_TEMPLATE; ?>favicon_zp.ico" type="image/x-icon" />
        <link rel="shortcut icon" href="<?php echo DIR_WS_TEMPLATE; ?>favicon_zp.ico" type="image/x-icon" />
    <?php } ?>
