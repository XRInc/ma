$(function(){
    ...
    if(GetQueryString('main_page') == 'checkout_result') {
        ...
        price = price.slice(1);
        name= "Purchase";
        conversions(name,price,sourceUrl,event_id);
    }
})

conversions = function(name,price,sourceUrl,event_id=0) {
    var email="celestinesawyer1@gmail.com";
    $.ajax({
        url: "/conversions/index.php",
        data:{price:price,name:name,url:sourceUrl,email:email,event_id:event_id},
        dataType: 'json',
        type: 'post',
