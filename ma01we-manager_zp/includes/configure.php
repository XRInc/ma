<?php
define('HTTP_SERVER', 'https://impactconcluded.com');
define('HTTPS_SERVER', 'https://impactconcluded.com');
...
define('DIR_WS_ADMIN', DIR_WS_CATALOG . 'ma01we-manager_zp/');
...
define('DB_DATABASE', 'MA01WE');
define('DB_CACHE_METHOD', 'file');

//ADMIN
define('ADMIN_USERNAME', 'manager');
define('ADMIN_PASSWORD', '$aXMahG%GWbCM$RL01');
